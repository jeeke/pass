...
public class ToolbarHelper {
    ...
    public ToolbarHelper(Activity context, MotionLayout v){
        toolbar = v;
        open = false;
        v.findViewById(R.id.action_search).setOnClickListener((View view) -> launchActivity(context, SearchActivity.class));
        v.findViewById(R.id.menu_icon).setOnClickListener(this::toggleToolBar);
        v.findViewById(R.id.chats).setOnClickListener((View view) -> launchActivity(context, SettingActivity.class));
        v.findViewById(R.id.support).setOnClickListener((View view) -> launchActivity(context, ContactUs.class));
        v.findViewById(R.id.my_posts).setOnClickListener((View view) -> launchActivity(context, PrevPosts.class));
    }
