...
import com.esselion.pass.adapters.TabAdapter.Companion.TYPE_CHAT
...
class ChatContainer : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val sectionsPagerAdapter = TabAdapter(TYPE_CHAT, childFragmentManager, FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT)
    ...
    private fun initToolbar() {
        ...
        a?.supportActionBar?.title = "Chats"
    }
}